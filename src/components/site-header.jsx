...
export function SiteHeader() {
  ...
  const pathTitles = {
    ...
    "/health-metrics/sam": "Health Metrics: SAM Cases Report",
    "/health-metrics/mam": "Health Metrics: MAM Cases Report",
    "/health-metrics/bp-cases": "Health Metrics: BP Cases Report",
    "/health-metrics/sugar-cases": "Health Metrics: Blood Sugar Cases Report",
